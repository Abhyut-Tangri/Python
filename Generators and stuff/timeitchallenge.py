...
fact_time = timeit.timeit(stmt=fact_test, number=10000)
factorial_time = timeit.timeit(stmt=factorial_test, number=10000)

print(f" fact time: {fact_time}")
print(f"factorial time: {factorial_time}")
